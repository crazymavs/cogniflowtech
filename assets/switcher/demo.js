...
jQuery(document).ready(function ($) {
  ...
  jQuery('.color3').click(function () {
    ...
    $('.header-v2 .logo img').attr(
      'src',
      'images/Header/logo-green-invest.png'
    );
  ...
  jQuery('.color5').click(function () {
    ...
    $('.header-v2 .logo img').attr(
      'src',
      'images/Header/logo-orange-invest.png'
    );
  ...
  jQuery('.color9').click(function () {
    ...
    $('.header-v2 .logo img').attr(
      'src',
      'images/Header/logo-yellow-invest.png'
    );
  ...
  jQuery('#tm-layout-switch').on('change', function () {
    if ($('#tm-layout-switch').val() == 'wide') {
      ...
      $('.finance-boxed-bg').css(
        'background-image',
        'url(switcher/images/patern01.png)'
      );
    }
  });
  ...
  $('#switcher ul [class*="bg"]').click(function () {
    $('.finance-boxed-bg').css(
      'background-image',
      'url(switcher/images/patern' + $(this).attr('data-value') + '.png)'
    );
  });
});
